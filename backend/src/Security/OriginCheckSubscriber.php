 ...
 * bumped to 1000/15min there. OriginCheckSubscriberTest exercises this
 * directly instead, bypassing that toggle.
 */
final class OriginCheckSubscriber implements EventSubscriberInterface
{
    /**
     * @var list<string>
     */
    ...
    public function __construct(
        ...
        private readonly string $allowedOriginPattern,
    ) {}
