 ...
 * touching a specific item or category also checks AccessKeyGuard: a locked
 * category/item without a valid grant on the request either 403s or, for
 * list(), is just filtered out.
 */
#[OA\Response(
    response: 401,
