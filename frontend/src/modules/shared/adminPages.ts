// Część 13 — współdzielone przez AdminLayout (nawigacja wewnątrz /admin) i
// UserLayout (skrót do panelu admina wprost z sidebaru usera, żeby nie trzeba
// było najpierw wchodzić na /admin) — jedna lista zamiast dwóch kopii.
