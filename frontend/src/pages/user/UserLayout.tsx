...
// nav, the same way AdminLayout does for /admin — both render the very same
// AppSidebar (Część 13: one identical sidebar for both areas, not two
// separate ones), only the navbar title and the <Outlet/> content differ.
